        ...
        {especie.imagen ? (
          <img
            ...
            onError={(e) => {
              ...
              e.target.parentElement.innerHTML = `<div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-green-100 to-emerald-50"><span class="text-5xl">${getTipoEmoji(especie.tipo)}</span></div>`
            }}
          />
        ) : (
